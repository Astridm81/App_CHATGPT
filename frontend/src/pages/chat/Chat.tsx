                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Ich bin BUKI, die Künstliche Intelligenz der Bundesforste - Stell mir deine Fragen!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Der Chatbot beantwortet deine Fragen</h2>
                            </Stack>
                        ) : (
